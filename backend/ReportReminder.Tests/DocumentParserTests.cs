...
public class DocumentParserTests
{
    ...
    public DocumentParserTests()
    {
        ...
        _parser = new DocumentParserService(configMock.Object, NullLogger<DocumentParserService>.Instance);
    }

    [Fact]
    public void ParseTextContent_IsoDate_ExtractsCorrectDateAndTitle()
    {
        string content = "請於 2026-09-30 交付期中報告與簡報資料。";
        var result = _parser.ParseTextContent("test.txt", content);
    ...
    [Fact]
    public void ParseTextContent_RocDate_ConvertsToGregorianDate()
    {
        string content = "專案結案報告截止日期為 115年10月25日。";
        var result = _parser.ParseTextContent("sample.txt", content);
    ...
    [Fact]
    public void ParseTextContent_ChineseStandardDate_ExtractsCorrectly()
    {
        string content = "初稿審查會訂於 2026年11月12日 召開。";
        var result = _parser.ParseTextContent("notice.txt", content);
    ...
    [Fact]
    public void ParseTextContent_MultipleLines_ParsesAllMatchingDates()
    {
...
結案報告 2026/12/20 審查";
        ...
        var result = _parser.ParseTextContent("schedule.txt", content);
